      ...
      <div className="w-full relative">
        ...
        <div className="flex items-center">
          <h1 className="pt-5 text-[25px]">
            {courseData?.price === 0 ? "Free" : courseData?.price + "EG"}
          </h1>
          <h5 className="pl-3 text-[20px] mt-2 line-through opacity-80">
            {courseData?.estimatedPrice}EG
          </h5>
        ...
        <div className="flex items-center">
          <div
            className={`${styles.button} !w-[190px] my-3 font-Poppins !bg-[crimson] cursor-not-allowed`}
          >
            Buy Now{courseData?.price}EG
          </div>
        </div>
        ...
        <p className="pb-1">● Certificate after complete the course</p>
