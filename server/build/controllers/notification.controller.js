...
exports.getNotification = (0, catshAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
...
exports.updateNotification = (0, catshAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
