...
exports.generateVideoUrl = exports.getAllCourse = exports.addReplyToReview = exports.addReview = exports.addAnswer = exports.addQuestion = exports.getCourseByUser = exports.getAllCourses = exports.getSingleCourse = exports.editCourse = exports.uploadCourse = void 0;
...
//upload course
exports.uploadCourse = (0, catshAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
        const data = req.body;
...
// edit course
exports.editCourse = (0, catshAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
        const data = req.body;
        const thumbnail = data.thumbnail;
...
exports.getSingleCourse = (0, catshAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
        const courseId = req.params.id;
        const isCasheExist = await redis_1.redis.get(courseId);
        if (isCasheExist) {
...
exports.getAllCourses = (0, catshAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
...
exports.getCourseByUser = (0, catshAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
        const userCourseList = req.user?.courses;
        const courseId = req.params.id;
        const courseExists = userCourseList?.find((course) => course.courseId === courseId);
        if (!courseExists) {
            return next(new ErrorHandler_1.default("you are not have the permission to access this course", 400));
        }
...
exports.addQuestion = (0, catshAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
...
exports.addAnswer = (0, catshAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
...
exports.addReview = (0, catshAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
        const userCourseList = req.user?.courses;
        const courseId = req.params.id;
        ...
        if (!courseExists) {
            return next(new ErrorHandler_1.default("You are not have the permission to access this course", 404));
        }
        const course = await course_model_1.default.findById(courseId);
...
exports.addReplyToReview = (0, catshAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
...
exports.getAllCourse = (0, catshAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
...
//GENERATE VIDEO URL 
exports.generateVideoUrl = (0, catshAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
