...
courseRouter.get("/get-courses-content/:id", user_controller_1.updateAccessToken, auth_1.isAutheticated, course_controller_1.getCourseByUser);
...
courseRouter.get("/get-admin-courses", user_controller_1.updateAccessToken, auth_1.isAutheticated, (0, auth_1.authorizeRoles)("admin"), course_controller_1.getAllCourse);
courseRouter.post("/getVdoCipherOTP", course_controller_1.generateVideoUrl);
courseRouter.delete("/delete-course/:id", user_controller_1.updateAccessToken, auth_1.isAutheticated, (0, auth_1.authorizeRoles)("admin"), user_controller_1.deleteCourse);
