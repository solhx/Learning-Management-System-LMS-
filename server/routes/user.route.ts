...
import { activateUser, getUserInfo,updateProfilePicture, loginUser, logoutUser, registrationUser,socialAuth,updateAccessToken, updatePassword, updateUserInfo, getAllUsers, updateUserRole, deleteUser } from "../controllers/user.controller";
