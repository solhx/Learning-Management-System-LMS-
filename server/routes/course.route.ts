...
import { addAnswer, addQuestion, addReplyToReview, addReview, editCourse, generateVideoUrl, getAllCourse, getAllCourses, getCourseByUser, getSingleCourse, uploadCourse } from "../controllers/course.controller";
...
courseRouter.get("/get-courses-content/:id",updateAccessToken,isAutheticated,getCourseByUser);
...
courseRouter.get("/get-admin-courses",updateAccessToken,isAutheticated,authorizeRoles("admin"),getAllCourse);
